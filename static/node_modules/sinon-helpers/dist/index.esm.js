...
import { createFunc, createArg } from 'fluent-arguments';
...
var getStubOrSpyConstructor = ( /* tree-shaking no-side-effects-when-called */function (getConstructorProperties) {
  return function (Target) {
    ...
    StubOrSpyConstructor[constructorProps.addMethodsKey] = createFunc(function (methods) {
...
var getMethodStubs = createFunc(getMethodStubsHandler);

var returning = createArg({
  args: [ARG_RETURN_VAL],
  extendsPrevious: true
});

var returningThis = createArg({
  extra: { returnThis: true },
  extendsPrevious: true
});

export { getStubConstructor, getSpyConstructor, getMethodStubs, returning, returningThis };
